...
REPORT_PATH = Path("selenium_report.json")
...
def create_test_run(report: dict) -> int:
    ...
    payload = {
        ...
        "run_name": "Selenium UI Run",
        "source_type": "selenium",
        "source_name": "local-selenium-pytest",
...
def parse_error_message(test: dict) -> str | None:
    ...
    return "Unknown Selenium test failure"
...
def main() -> None:
    ...
    print(f"Uploaded selenium results into test_run_id={test_run_id}")
